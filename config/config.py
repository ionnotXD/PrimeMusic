...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ionmusic/PrimeMusic",
)
...
AUTO_LEAVE_ASSISTANT_TIME = int(
    getenv("ASSISTANT_LEAVE_TIME", "86400")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/Toni880/PrimeMusic")
...
TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "5368709120")
)  # Remember to give value in bytes
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://telegra.ph/file/5de47009aaf093ef8012a.jpg")
